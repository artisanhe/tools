...
import (
	...
	"github.com/artisanhe/tools/catgo/cat-go/message"
)
...
func (m *catMonitor) buildXml() *bytes.Buffer {
	...
	status.CustomInfos = append(status.CustomInfos, CustomInfo{"catgolangclient-version", CatClientVersion})
...
func (m *catMonitor) collectAndSend() {
	...
	trans.LogEvent("Cat_golang_Client_Version", CatClientVersion)
