...
import (
	...
	"github.com/artisanhe/tools/mq"
	mq_redis "github.com/artisanhe/tools/mq/redis"
	"github.com/artisanhe/tools/reflectx"
	"github.com/artisanhe/tools/timelib"
)
...
func (Agent) DockerDefaults() conf.DockerDefaults {
	return conf.DockerDefaults{
		"Host": "redis", //conf.RancherInternal("tool-deps", "redis"),
		"Port": 36379,
	}
}
