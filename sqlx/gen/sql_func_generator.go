...
func (g *Config) Defaults() {
	...
	if g.ConstSoftDeleteTrue == "" {
		g.ConstSoftDeleteTrue = "github.com/artisanhe/tools/courier/enumeration.BOOL__TRUE"
	}

	if g.ConstSoftDeleteFalse == "" {
		g.ConstSoftDeleteFalse = "github.com/artisanhe/tools/courier/enumeration.BOOL__FALSE"
	}
