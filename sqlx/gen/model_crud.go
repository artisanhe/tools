...
func (m *Model) methodsForBasic() string {
	...
	m.ParseTo(buf, `
	{{ $method := "Create"}}
	func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/artisanhe/tools/sqlx" }}.DB) error {
	{{ ( .EnableIfNeed ) }}
	{{ ( .SetCreatedAtIfNeed ) }}
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/artisanhe/tools/sqlx" }}.DB) (err error) {
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/artisanhe/tools/sqlx" }}.DB, updateFields []string) error {
	...
	fieldValues := {{ use "github.com/artisanhe/tools/sqlx" }}.FieldValuesFromStructByNonZero({{ var .StructName }}, updateFields...)
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/artisanhe/tools/sqlx" }}.DB) error {
	...
	stmt := table.Select().
		Comment("{{ .StructName }}.{{ $method }}").
		Where({{ use "github.com/artisanhe/tools/sqlx/builder" }}.And(
			%s
		))
...
{{ $method := "%s" }}
{{ $methodForFetch := "%s" }}
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/artisanhe/tools/sqlx" }}.DB, fieldValues {{ use "github.com/artisanhe/tools/sqlx/builder" }}.FieldValues) error {
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/artisanhe/tools/sqlx" }}.DB, zeroFields ...string) error {
	fieldValues := {{ use "github.com/artisanhe/tools/sqlx" }}.FieldValuesFromStructByNonZero({{ var .StructName }}, zeroFields...)
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/artisanhe/tools/sqlx" }}.DB) error {
	...
	fieldValues := {{ use "github.com/artisanhe/tools/sqlx/builder" }}.FieldValues{}
	...
	err := dbRet.Err()
	if err != nil {
		dbErr := {{ use "github.com/artisanhe/tools/sqlx" }}.DBErr(err)
		if dbErr.IsConflict() {
